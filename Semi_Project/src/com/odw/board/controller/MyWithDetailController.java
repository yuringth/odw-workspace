...
/**
 * Servlet implementation class MyWithDetailController
 */
@WebServlet("/MyWithDetail.bo")
public class MyWithDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyWithDetailController() {
        super();
