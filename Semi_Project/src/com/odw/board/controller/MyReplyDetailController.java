...
/**
 * Servlet implementation class myReplyDetail
 */
@WebServlet("/myReplyDetail.bo")
public class MyReplyDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyReplyDetailController() {
        super();
