...
/**
 * Servlet implementation class AjaxAccompanyAddController
 */
@WebServlet("/accompanyAdd.bo")
public class AjaxAccompanyAddController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxAccompanyAddController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board b = new AccompanyBoardService().accompanyAdd(a);
