...
/**
 * Servlet implementation class AjaxAccompanyAddButtonController
 */
@WebServlet("/accompanyAddYN.bo")
public class AjaxAccompanyAddButtonController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxAccompanyAddButtonController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board b = new AccompanyBoardService().SelectAccompanyAddButton(a);
