...
<%@ include file="../../common/navbar.jsp" %>
	<div class="outer">
		...
		<form action="<%= contextPath %>/update.qa" method="post" id="updateForm">
			<input type="hidden" name="bno" value="<%= b.getBoardNo() %>">
			<div class="updateForm-area">
				<table class="updateForm-top" align="center" >
                    <tr>
						<th>제목</th>
					...
					<tr>
						<th>내용</th>
						<td><textarea name="content" style="resize: none;" rows="10" required><%= b.getBoardContent() %></textarea></td>
					</tr>
				</table>
				<br>

				<div align="center">
					<button type="submit" class="btn btn-sm btn-success" style="width: 40%; height: 50px;" >수정하기</button>
					&nbsp&nbsp
                	<button type="reset" class="btn btn-sm btn-light" onclick="history.back();" style="width: 40%; height: 50px;">뒤로가기</button>
				</div>
			</form>
    </div>
</body>
